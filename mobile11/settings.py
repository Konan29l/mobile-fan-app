"""
Django settings for mobile11 mobile11.
...
ALLOWED_HOSTS = ['mobile-fan-app.onrender.com', 'localhost', '127.0.0.1']
...
WSGI_APPLICATION = 'mobile11.wsgi.application'
